...
Lote Z: Inocuo`,
  ...
  },
  {
    ...
    description: "El banquero corrupto ocultó llaves de cajas de seguridad numeradas del 1 al 5. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito.",
    type: "construction",
    timeLimit: null,
    maxAttempts: null,
...
SAFE-0 (Externa)\n\nLas cortinas de la habitación 202 estaban completamente cerradas.`,
  ...
  },
  {
    ...
    description: "Furgonetas de la banda merodean los alrededores de los hospitales nocturnos. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre.",
    type: "construction",
    timeLimit: null,
    maxAttempts: null,
...
CAR-1 (Descartado)\n\nEl viento soplaba friamente en la calle principal.`,
  ...
  },
  {
    ...
    description: "El informante dictó extensiones telefónicas internas que comunican con la morgue y la red clínica. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada.",
    type: "construction",
    timeLimit: null,
    maxAttempts: null,
...
Línea falsa: EXT#9\n\nLa sombra de un extraño se proyectó brevemente en la pared.`,
  ...
  },
  {
    ...
    description: "Los reportes forenses de las víctimas confirman la extirpación quirúrgica de riñones y córneas. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal.",
    type: "construction",
    timeLimit: null,
    maxAttempts: null,
...
Caso 3: Sin órganos vitales\n\nNadie parecía notar el rastro dejado en el asfalto mojado.`,
  ...
  },
  {
    ...
    description: "La banda de Falcone exige rescates mientras desvalija las viviendas de los desaparecidos. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche.",
    type: "construction",
    timeLimit: null,
    maxAttempts: null,
...
No acepto cheques.\n\nEl vigilante hacía su ronda alumbrando con una linterna gastada.`,
  ...
  },
  {
    ...
    description: "Vance encuentra la lista de clientes con nombres tachados en rojo y cartas dirigidas a la Dra. Cross y el Dr. Miller. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales.",
    type: "construction",
    timeLimit: null,
    maxAttempts: null,
...
Sin título: Jones\n\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.`,
  ...
  // ========================================================
  {
    ...
    description: "¡Los camiones frigoríficos de transporte urgente de órganos están despegando del muelle! Tienes 90 segundos para capturar las matrículas oficiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil.",
    type: "construction",
    timeLimit: 90,
    maxAttempts: 5,
    documentTitle: "CONTROL DE SALIDAS EN EL MUELLE",
    sourceText: `Se escuchó un crujido proveniente del viejo muelle de madera.\n\nFURGONES DETECTADOS:
Furgón A: ABC-1234
Furgón B: XYZ-9876
Camioneta: TAXI-99
Furgón D: MET-5541\n\nEl informe de las 04:00 AM no mostraba novedades inusuales.`,
  ...
  },
  {
    ...
    description: "Los contenedores etiquetados con prefijo 'BOX_' contienen frascos con preservantes de tejido humano. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes.",
    type: "construction",
    timeLimit: 90,
    maxAttempts: 5,
    documentTitle: "MANIFIESTO DE CARGA BIOLÓGICA",
    sourceText: `Los faros del vehículo iluminaron por un instante el callejón.\n\nCARGAMENTO ADUANERO:
...
ITEM# (Invalido)\n\nLas luces de neón parpadeaban sin cesar en la noche oscura.`,
  ...
  },
  {
    ...
    description: "Fechas registradas en la libreta del intermediario donde se anotaron las operaciones de trasplante. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven.",
    type: "construction",
    timeLimit: 90,
    maxAttempts: 5,
    documentTitle: "CALENDARIO DE TRASPLANTES",
    sourceText: `El ruido sordo de un motor diesel provenía de los almacenes.\n\nCITAS QUIRÚRGICAS:
...
Ano 1945\n\nSe escuchó un crujido proveniente del viejo muelle de madera.`,
  ...
  },
  {
    ...
    description: "Frankie anotó en clave los apodos de los miembros de Falcone que allanaban los apartamentos de las víctimas. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros.",
    type: "construction",
    timeLimit: 90,
    maxAttempts: 5,
    documentTitle: "DIARIO CONFIDENCIAL DE FRANKIE",
    sourceText: `Los faros del vehículo iluminaron por un instante el callejón.\n\nINTEGRANTES DEL GRUPO DE SAQUEO:
...
Falso: PERRO1\n\nLas cortinas de la habitación 202 estaban completamente cerradas.`,
  ...
  },
  {
    ...
    description: "Transferencias secretas emitidas por la Clínica Renacer hacia el sindicato criminal de Carmine Falcone. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre.",
    type: "construction",
    timeLimit: 90,
    maxAttempts: 5,
    documentTitle: "LIBRO DE PAGOS A LA MAFIA",
    sourceText: `La sombra de un extraño se proyectó brevemente en la pared.\n\nTRANSFERENCIAS DE LA CLÍNICA:
...
TX-12 (Demasiado corta)\n\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nEl conserje dormitaba en su silla sin prestar atención.`,
  ...
  },
  {
    ...
    description: "Falcone intentó liquidar a Vance con un artefacto explosivo programado con Regex. ¿Qué códigos activan la detonación? Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada.",
    ...
    criminalFlags: "m",
    sourceText: `El informe de las 04:00 AM no mostraba novedades inusuales.\n\nCÓDIGOS DETECTADOS EN EL CIRCUITO:
Linea 1: BOMB-102-X
Linea 2: BOMB-99-A
...
Linea 4: BOMB-774-Z\n\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nUn papel arrugado yacía junto al bote de basura.`,
  ...
  },
  {
    ...
    description: "Antinarcóticos creía que eran drogas, pero los pesajes en gramos corresponden a suero para evitar el rechazo de los órganos. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal.",
    type: "construction",
    timeLimit: 90,
    maxAttempts: 5,
    documentTitle: "PESAJE DE REACTIVOS DE LABORATORIO",
    sourceText: `Las luces de neón parpadeaban sin cesar en la noche oscura.\n\nINVENTARIO DE CONSERVACIÓN:
Paquete A: 100g
Paquete B: 250g
Paquete C: 500g
Paquete D: 2kg\n\nLos faros del vehículo iluminaron por un instante el callejón.\nUn perro ladró a lo lejos rompiendo el silencio.`,
  ...
  },
  {
    ...
    description: "El maletín de Falcone contiene las listas de apartamentos saqueados tras desvivir a sus ocupantes. Descifra la clave. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche.",
    type: "criminal_cipher",
    timeLimit: 90,
    maxAttempts: 5,
...
Clave 4: TX*12*CA\n\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nUn archivo polvoriento reposaba sobre el escritorio.`,
  ...
  },
  {
    ...
    description: "Llamadas telefónicas entre los lugartenientes de Falcone y la centralita privada de la Clínica Renacer. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales.",
    type: "construction",
    timeLimit: 90,
    maxAttempts: 5,
...
Contacto: 555-7744\n\nEl conserje dormitaba en su silla sin prestar atención.\nNadie se atrevía a caminar por ese sector después del anochecer.`,
  ...
  },
  {
    ...
    description: "Cuentas en Ginebra y Zúrich desde donde magnates pagan fortunas por los trasplantes clandestinos. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil.",
    type: "construction",
    timeLimit: 90,
    maxAttempts: 5,
...
Nueva York: US-991\n\nLas cajas apiladas formaban un laberinto casi impenetrable.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.`,
  ...
  // ========================================================
  {
    ...
    description: "Rob confiesa aterrado que las víctimas del allanamiento tenían citas previas en la Clínica Renacer antes de desaparecer. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes.",
    type: "construction",
    timeLimit: 80,
    maxAttempts: 5,
...
Nadie ayudó a Rob en la fuga.\n\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nUn relámpago iluminó el cielo amenazando con una tormenta inminente.`,
  ...
  },
  {
    ...
    description: "Aumentan las alertas policiales por desapariciones de personas que acudieron a consultas privadas en la clínica. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven.",
    type: "construction",
    timeLimit: 80,
    maxAttempts: 5,
...
RUMOR: Se escucharon disparos.\n\nLa sombra de un extraño se proyectó brevemente en la pared.\nLos faros del vehículo iluminaron por un instante el callejón.`,
  ...
  },
  {
    ...
    description: "Los mensajes de los sicarios que confirman las extracciones terminan con la palabra ritual '[FIN]' (segundo sello del destierro). Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros.",
    type: "construction",
    timeLimit: 80,
    maxAttempts: 5,
...
Mensaje sin confirmar\n\nSe escuchó un crujido proveniente del viejo muelle de madera.\nNadie parecía notar el rastro dejado en el asfalto mojado.`,
  ...
  },
  {
    ...
    description: "Los sicarios usaban carnés médicos falsos para circular por los hospitales sin levantar sospechas. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito.",
    type: "criminal_cipher",
    timeLimit: 80,
    maxAttempts: 5,
...
Carné 4: AGENT_555_ru (en minúscula)\n\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nUn archivo polvoriento reposaba sobre el escritorio.`,
  ...
  },
  {
    ...
    description: "Códigos de 6 caracteres que abren la cámara refrigerada donde reposan los órganos recién extirpados. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada.",
    type: "construction",
    timeLimit: 80,
    maxAttempts: 5,
...
X99999 (Invalido)\n\nLas huellas en el barro indicaban que alguien había estado allí recientemente.\nEl ruido sordo de un motor diesel provenía de los almacenes.\nEl barman limpiaba distraídamente un vaso de cristal.`,
  ...
  },
  {
    ...
    description: "Los cómplices de la Dra. Cross solo huyen en 'Sedan' o 'Avioneta' bimotor. Filtra ambos transportes. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal.",
    type: "construction",
    timeLimit: 80,
    maxAttempts: 5,
...
4. Retorno en Sedan gris\n\nLa sombra de un extraño se proyectó brevemente en la pared.\nLas cortinas de la habitación 202 estaban completamente cerradas.\nEl vigilante hacía su ronda alumbrando con una linterna gastada.`,
  ...
  },
  {
    ...
    description: "Falcone configuró un filtro para encubrir los envíos de órganos bajo la etiqueta de armas y sustancias. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche.",
    type: "criminal_cipher",
    timeLimit: 80,
    maxAttempts: 5,
...
Línea D: ARMAS-MEDIA\n\nLas cortinas de la habitación 202 estaban completamente cerradas.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.`,
  ...
  },
  {
    ...
    description: "El testigo tartamudea aterrorizado al relatar cómo vio a un ser de traje oscuro que no proyecta sombra. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales.",
    type: "construction",
    timeLimit: 80,
    maxAttempts: 5,
...
Ano 1890\n\nLas cortinas de la habitación 202 estaban completamente cerradas.\nUn perro ladró a lo lejos rompiendo el silencio.\nNadie parecía notar el rastro dejado en el asfalto mojado.`,
  ...
  },
  {
    ...
    description: "Cuentas corporativas en EE.UU. y Suiza que financian los experimentos biomecánicos del sanatorio. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes.",
    type: "construction",
    timeLimit: 80,
    maxAttempts: 5,
...
ACC-US-8812 (Miami)\n\nLa sirena de una ambulancia resonó a varias calles de distancia.\nUn periódico viejo volaba arrastrado por la brisa otoñal.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.`,
  ...
  // ========================================================
  {
    ...
    description: "Declaración judicial donde el testigo confiesa haber presenciado cánticos y figuras oscuras en el sótano de la clínica. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven.",
    type: "construction",
    timeLimit: 75,
    maxAttempts: 4,
...
El testigo gritó: "¡cuidado con el arma!" y luego "¡corran todos!".\n\nLas letras del letrero 'ABIERTO' estaban medio fundidas.\nEl viento soplaba friamente en la calle principal.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.`,
  ...
  },
  {
    ...
    description: "¡Bomba de tiempo en el muelle! Los criminales configuraron un validador con etiquetas HTML. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros.",
    type: "criminal_cipher",
    timeLimit: 75,
    maxAttempts: 4,
  ...
  },
  {
    ...
    description: "Recipientes de vidrio rotulados entre corchetes que contienen los órganos preservados para los trasplantes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito.",
    type: "construction",
    timeLimit: 75,
    maxAttempts: 4,
...
Texto sin corchetes.\n\nLas gaviotas revoloteaban sobre los barcos pesqueros.\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nLa música de jazz sonaba suavemente desde un tocadiscos lejano.`,
  ...
  },
  {
    ...
    description: "Base de datos con las identidades deudoras clasificadas con prefijos sin captura '(?:REF|ID)-\\d{4}'. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre.",
    type: "construction",
    timeLimit: 75,
    maxAttempts: 4,
...
COD-00 (Descartado)\n\nLas huellas en el barro indicaban que alguien había estado allí recientemente.\nUn gato negro saltó desde el muro y desapareció en las sombras.\nEl semáforo parpadeaba en amarillo sin que nadie lo respetara.`,
  ...
  },
  {
    ...
    description: "Tarifas astronómicas en dólares pagadas por la élite por extender sus vidas a costa de víctimas inocentes. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal.",
    type: "construction",
    timeLimit: 75,
    maxAttempts: 4,
    documentTitle: "BALANZA CONTABLE DE TRASPLANTES",
    sourceText: `Había colillas de cigarrillos esparcidas cerca de la entrada.\nLa sombra de un extraño se proyectó brevemente en la pared.\nLa música de jazz sonaba suavemente desde un tocadiscos lejano.\n\nTRANSACCIONES DE TRASPLANTE:
Cobro: $120.50
Depósito: $500.00
Comisión: $15.75
Sin centavos: $99\n\nEl conserje dormitaba en su silla sin prestar atención.\nNadie se atrevía a caminar por ese sector después del anochecer.\nEl barman limpiaba distraídamente un vaso de cristal.\nEl viento soplaba friamente en la calle principal.`,
  ...
  },
  {
    ...
    description: "Falcone ha colocado dinamita en las cajas de suministros para volar las pruebas forenses. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche.",
    type: "construction",
    timeLimit: 75,
    maxAttempts: 4,
...
Caja PELIGRO (Dinamita)\n\nUn papel arrugado yacía junto al bote de basura.\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nUn gato negro saltó desde el muro y desapareció en las sombras.`,
  ...
  },
  {
    ...
    description: "Los cirujanos intentan huir en buques no militares antes de que llegue la Guardia Nacional. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales.",
    type: "construction",
    timeLimit: 75,
    maxAttempts: 4,
...
BARCO PESQUERO\n\nEn la radio se informaba sobre las bajas temperaturas.\nUn gato negro saltó desde el muro y desapareció en las sombras.\nUn relámpago iluminó el cielo amenazando con una tormenta inminente.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.`,
  ...
  },
  {
    ...
    description: "El despacho de la doctora está blindado con un validador complejo de contraseña con lookaheads. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil.",
    type: "criminal_cipher",
    timeLimit: 75,
    maxAttempts: 4,
...
Clave D: Ab1 (Muy corta)\n\nNadie parecía notar el rastro dejado en el asfalto mojado.\nUn relámpago iluminó el cielo amenazando con una tormenta inminente.\nLa sombra de un extraño se proyectó brevemente en la pared.\nUn archivo polvoriento reposaba sobre el escritorio.`,
  ...
  },
  {
    ...
    description: "Libro de registro arcaico donde se anotaron los pagos de sangre del pacto. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes.",
    type: "construction",
    timeLimit: 75,
    maxAttempts: 4,
...
COBRO: 80\n\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nLa música de jazz sonaba suavemente desde un tocadiscos lejano.\nUn papel arrugado yacía junto al bote de basura.`,
  ...
  },
  {
    ...
    description: "Códigos de autenticación para ingresar a los servidores maestros antes de que se inicie el protocolo de autodestrucción. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven.",
    type: "construction",
    timeLimit: 75,
    maxAttempts: 4,
...
PASS_4412_OK\n\nEl viento soplaba friamente en la calle principal.\nEl candado de la puerta trasera parecía oxidado pero intacto.\nLos faros del vehículo iluminaron por un instante el callejón.\nEl semáforo parpadeaba en amarillo sin que nadie lo respetara.`,
  ...
  // ========================================================
  {
    ...
    description: "Una fuerza sobrenatural introdujo un ataque ReDoS ^(a+)+$ en el sistema para colapsar las redes de la ciudad. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros.",
    type: "criminal_cipher",
    timeLimit: 65,
    maxAttempts: 4,
...
aaaaaaaaaaaaaaaaaaaaaaaaaaaaab (falla al final)\n\nEl viento soplaba friamente en la calle principal.\nEl semáforo parpadeaba en amarillo sin que nadie lo respetara.\nUn archivo polvoriento reposaba sobre el escritorio.\nEl vigilante hacía su ronda alumbrando con una linterna gastada.`,
  ...
  },
  {
    ...
    description: "Vance reescribe el algoritmo de autenticación de forma lineal para restablecer las alarmas antes de la detonación. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito.",
    type: "construction",
    timeLimit: 65,
    maxAttempts: 4,
...
TOKEN_GAMMA_44\n\nLa sombra de un extraño se proyectó brevemente en la pared.\nUn gato negro saltó desde el muro y desapareció en las sombras.\nEl eco del agua goteando de una tubería rota marcaba el ritmo de la espera.\nLas luces de neón parpadeaban sin cesar en la noche oscura.`,
  ...
  },
  {
    ...
    description: "Correos electrónicos intervenidos que autorizan la entrega de deudores para su intervención quirúrgica. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre.",
    type: "construction",
    timeLimit: 65,
    maxAttempts: 4,
...
espia@muelle.com\n\nEl barman limpiaba distraídamente un vaso de cristal.\nEl informe de las 04:00 AM no mostraba novedades inusuales.\nEl ruido sordo de un motor diesel provenía de los almacenes.\nLa sirena de una ambulancia resonó a varias calles de distancia.`,
  ...
  },
  {
    ...
    description: "La regla de firewall del búnker contiene una vulnerabilidad que delata la dirección IP de la cámara de invocación. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada.",
    type: "criminal_cipher",
    timeLimit: 65,
    maxAttempts: 4,
...
3) 10.0.0.1\n\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nEl viento soplaba friamente en la calle principal.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nLas letras del letrero 'ABIERTO' estaban medio fundidas.`,
  ...
  },
  {
    ...
    description: "Falcone ha cebado los cimientos del hospital con cargas de TNT. Desactiva los detonadores activos antes de que exploten. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche.",
    type: "construction",
    timeLimit: 65,
    maxAttempts: 4,
    documentTitle: "MANIFIESTO DE DETONADORES ACTIVOS",
    sourceText: `Un perro ladró a lo lejos rompiendo el silencio.\nEl olor a salitre y humo impregnaba el ambiente portuario.\nUn gato negro saltó desde el muro y desapareció en las sombras.\nNadie se atrevía a caminar por ese sector después del anochecer.\n\nCARGAS DE TNT ACTIVAS:
TNT-8891-A (Activo)
TNT-1024-B (Activo)
...
C4-001-A (Otro tipo)\n\nEl barman limpiaba distraídamente un vaso de cristal.\nUn periódico viejo volaba arrastrado por la brisa otoñal.\nEl conserje dormitaba en su silla sin prestar atención.\nLas cortinas de la habitación 202 estaban completamente cerradas.\nUn coche negro aceleró y dobló la esquina rápidamente.`,
  ...
  },
  {
    ...
    description: "¡Los últimos camiones con órganos extraídos están escapando hacia alta mar! Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales.",
    type: "construction",
    timeLimit: 65,
    maxAttempts: 4,
...
TRUCK-002-B\n\nLas gaviotas revoloteaban sobre los barcos pesqueros.\nLas huellas en el barro indicaban que alguien había estado allí recientemente.\nEl conserje dormitaba en su silla sin prestar atención.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.`,
  ...
  },
  {
    ...
    description: "Carmine Falcone activa su último detonador de C4 para inmolarse y llevarse el secreto a la tumba. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil.",
    type: "criminal_cipher",
    timeLimit: 65,
    maxAttempts: 4,
...
4: ALPHA_12_WIN\n\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.\nEl ruido sordo de un motor diesel provenía de los almacenes.\nLas letras del letrero 'ABIERTO' estaban medio fundidas.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nUna figura envuelta en una gabardina cruzó la avenida.`,
  ...
  },
  {
    ...
    description: "Runas rituales dejadas en el espejo por donde se manifiesta Malphas. Vance busca los renglones cifrados. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes.",
    type: "construction",
    timeLimit: 65,
    maxAttempts: 4,
...
#INVAL_X\n\nEl ruido sordo de un motor diesel provenía de los almacenes.\nLa sirena de una ambulancia resonó a varias calles de distancia.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nLas huellas en el barro indicaban que alguien había estado allí recientemente.`,
  ...
  },
  {
    ...
    description: "Cuentas bancarias de la red criminal mayor que conecta la clínica con testaferros en todo el mundo. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven.",
    type: "construction",
    timeLimit: 65,
    maxAttempts: 4,
...
ACC-FR-8812-C\n\nUn coche negro aceleró y dobló la esquina rápidamente.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nUna figura envuelta en una gabardina cruzó la avenida.\nEn la radio se informaba sobre las bajas temperaturas.\nLas luces de neón parpadeaban sin cesar en la noche oscura.`,
  ...
  },
  {
    ...
    description: "Cerradura maestra de la puerta que conduce al santuario subterráneo. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros.",
    type: "construction",
    timeLimit: 65,
    maxAttempts: 4,
...
MASTER_KEY_123 (Corta)\n\nLas huellas en el barro indicaban que alguien había estado allí recientemente.\nEl conserje dormitaba en su silla sin prestar atención.\nLas gaviotas revoloteaban sobre los barcos pesqueros.\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nEl ruido sordo de un motor diesel provenía de los almacenes.`,
  ...
  // ========================================================
  {
    ...
    description: "Los órganos cosechados poseen compatibilidad perfecta antinatural. Identifica los perfiles HLA. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito.",
    type: "construction",
    timeLimit: 55,
    maxAttempts: 3,
...
Donante 4: HLA-EF-771\n\nNadie se atrevía a caminar por ese sector después del anochecer.\nEl olor a café rancio inundaba la oficina del investigador.\nEl olor a salitre y humo impregnaba el ambiente portuario.\nLas huellas en el barro indicaban que alguien había estado allí recientemente.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.`,
  ...
  },
  {
    ...
    description: "Tanques de nitrógeno criogénico usados para congelar órganos en menos de 15 minutos. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre.",
    type: "construction",
    timeLimit: 55,
    maxAttempts: 3,
...
NITRO_882_C (Presurizado)\n\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.\nEn la radio se informaba sobre las bajas temperaturas.\nUna figura envuelta en una gabardina cruzó la avenida.\nEl informe de las 04:00 AM no mostraba novedades inusuales.\nEl eco del agua goteando de una tubería rota marcaba el ritmo de la espera.`,
  ...
  },
  {
    ...
    description: "El conserje confiesa temblando cómo vio al hombre de traje negro y repite palabras de pánico. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada.",
    type: "construction",
    timeLimit: 55,
    maxAttempts: 3,
...
El guardia se calmó lentamente.\n\nLa sombra de un extraño se proyectó brevemente en la pared.\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nUna figura envuelta en una gabardina cruzó la avenida.\nUn gato negro saltó desde el muro y desapareció en las sombras.`,
  ...
  },
  {
    ...
    description: "El capo codificó los informes de las viviendas allanadas con una regla regex. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal.",
    type: "criminal_cipher",
    timeLimit: 55,
    maxAttempts: 3,
    ...
    criminalFlags: "m",
    sourceText: `El conserje dormitaba en su silla sin prestar atención.\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nSe escuchó un crujido proveniente del viejo muelle de madera.\nEl semáforo parpadeaba en amarillo sin que nadie lo respetara.\nLas huellas en el barro indicaban que alguien había estado allí recientemente.\n\nCÓDIGOS DE CASAS SAQUEADAS:
1: SAQUEO-14-NYC
2: SAQUEO-9-LA
3: ROBO-22-MIA
4: SAQUEO-88-BOS\n\nNadie parecía notar el rastro dejado en el asfalto mojado.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nUn archivo polvoriento reposaba sobre el escritorio.\nLas letras del letrero 'ABIERTO' estaban medio fundidas.\nLas cajas apiladas formaban un laberinto casi impenetrable.`,
  ...
  },
  {
    ...
    description: "Embarcaciones clandestinas que transportan los contenedores hacia buques en aguas internacionales. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales.",
    type: "construction",
    timeLimit: 55,
    maxAttempts: 3,
...
SHIP-001 (Civil)\n\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nEl olor a salitre y humo impregnaba el ambiente portuario.\nUn periódico viejo volaba arrastrado por la brisa otoñal.\nLa sirena de una ambulancia resonó a varias calles de distancia.`,
  ...
  },
  {
    ...
    description: "Los frascos están clasificados con los nombres en latín de corazón, riñón e hígado. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil.",
    type: "construction",
    timeLimit: 55,
    maxAttempts: 3,
...
Muestra 4: HEPAR-4401 (Hígado)\n\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nEl conserje dormitaba en su silla sin prestar atención.\nEl semáforo parpadeaba en amarillo sin que nadie lo respetara.\nEl olor a salitre y humo impregnaba el ambiente portuario.\nEl viento soplaba friamente en la calle principal.\nEl barman limpiaba distraídamente un vaso de cristal.`,
  ...
  },
  {
    ...
    description: "Furgonetas y autos sin identificar que ingresan pacientes clandestinos por la puerta trasera. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes.",
    type: "construction",
    timeLimit: 55,
    maxAttempts: 3,
...
4) VAN-11Z\n\nEl viento soplaba friamente en la calle principal.\nEl vigilante hacía su ronda alumbrando con una linterna gastada.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nLas gaviotas revoloteaban sobre los barcos pesqueros.\nEl olor a salitre y humo impregnaba el ambiente portuario.\nEn la radio se informaba sobre las bajas temperaturas.`,
  ...
  },
  {
    ...
    description: "Contratos milenarios donde cada deudor se identifica al final de la línea como deudor oficial. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven.",
    type: "construction",
    timeLimit: 55,
    maxAttempts: 3,
...
Contrato inválido\n\nEl ruido sordo de un motor diesel provenía de los almacenes.\nUn coche negro aceleró y dobló la esquina rápidamente.\nLos faros del vehículo iluminaron por un instante el callejón.\nUn archivo polvoriento reposaba sobre el escritorio.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nLas cortinas de la habitación 202 estaban completamente cerradas.`,
  ...
  },
  {
    ...
    description: "Los deudores faustianos intentaban pedir auxilio al darse cuenta de que su plazo vencía. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros.",
    type: "construction",
    timeLimit: 55,
    maxAttempts: 3,
...
Operadora: CALL-881-99\n\nEl detective suspiró mientras encendía otro cigarrillo.\nUn papel arrugado yacía junto al bote de basura.\nUn relámpago iluminó el cielo amenazando con una tormenta inminente.\nLas cortinas de la habitación 202 estaban completamente cerradas.\nUn perro ladró a lo lejos rompiendo el silencio.\nLos faros del vehículo iluminaron por un instante el callejón.`,
  ...
  },
  {
    ...
    description: "Vance protege las pruebas originales recolectadas en una caja de seguridad con código maestro. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito.",
    type: "construction",
    timeLimit: 55,
    maxAttempts: 3,
...
Caja de Aduana: VANCE_SAFE_88310\n\nLos faros del vehículo iluminaron por un instante el callejón.\nEn la radio se informaba sobre las bajas temperaturas.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nEl conserje dormitaba en su silla sin prestar atención.\nUn gato negro saltó desde el muro y desapareció en las sombras.\nLas letras del letrero 'ABIERTO' estaban medio fundidas.`,
  ...
  // ========================================================
  {
    ...
    description: "Citas textuales entre comillas donde se describen las apariciones del demonio en la noche. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre.",
    type: "construction",
    timeLimit: 50,
    maxAttempts: 3,
...
El fiscal anotó: "las cirugías no son humanas" en su informe.\n\nNadie parecía notar el rastro dejado en el asfalto mojado.\nLas huellas en el barro indicaban que alguien había estado allí recientemente.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nLas gaviotas revoloteaban sobre los barcos pesqueros.\nUn relámpago iluminó el cielo amenazando con una tormenta inminente.`,
  ...
  },
  {
    ...
    description: "Mililitros exactos de suero biológico usados para mantener frescos los riñones y corazones. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada.",
    type: "construction",
    timeLimit: 50,
    maxAttempts: 3,
...
Dosis Corazón: 100.25ml\n\nEl olor a salitre y humo impregnaba el ambiente portuario.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nUn perro ladró a lo lejos rompiendo el silencio.\nUn gato negro saltó desde el muro y desapareció en las sombras.`,
  ...
  },
  {
    ...
    description: "El clasificador del sindicato comprueba muestras de sangre o médula con resultado POS o NEG. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal.",
    type: "criminal_cipher",
    timeLimit: 50,
    maxAttempts: 3,
...
Línea 4: SANGRE_A_POS\n\nUn gato negro saltó desde el muro y desapareció en las sombras.\nEl eco del agua goteando de una tubería rota marcaba el ritmo de la espera.\nEl semáforo parpadeaba en amarillo sin que nadie lo respetara.\nEl detective suspiró mientras encendía otro cigarrillo.\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nSe escuchó un crujido proveniente del viejo muelle de madera.`,
  ...
  },
  {
    ...
    description: "Cajas de instrumental importadas clandestinamente con prefijo 'SURGERY-' y 4 números. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche.",
    type: "construction",
    timeLimit: 50,
    maxAttempts: 3,
...
Lote 4: SURGERY-8812 (Catéteres)\n\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nEl informe de las 04:00 AM no mostraba novedades inusuales.\nLa sombra de un extraño se proyectó brevemente en la pared.\nLos ecos de pasos apresurados resonaban en el callejón vacío.`,
  ...
  },
  {
    ...
    description: "Candelabros encendidos para el ritual de invocación marcados como activos. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil.",
    type: "construction",
    timeLimit: 50,
    maxAttempts: 3,
...
Candelabro 4: TORCH_01_ON\n\nSe escuchó un crujido proveniente del viejo muelle de madera.\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nLos ecos de pasos apresurados resonaban en el callejón vacío.\nEl eco del agua goteando de una tubería rota marcaba el ritmo de la espera.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nEl viento soplaba friamente en la calle principal.\nUn archivo polvoriento reposaba sobre el escritorio.`,
  ...
  },
  {
    ...
    description: "Papeles quemados en la chimenea donde se lee el encabezado ritual del pacto con palabras de 6 mayúsculas. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes.",
    type: "construction",
    timeLimit: 50,
    maxAttempts: 3,
...
En la tercera decía: PACTO: NO válido.\n\nEl viento soplaba friamente en la calle principal.\nEn la radio se informaba sobre las bajas temperaturas.\nEl vigilante hacía su ronda alumbrando con una linterna gastada.\nEl ruido sordo de un motor diesel provenía de los almacenes.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nLos faros del vehículo iluminaron por un instante el callejón.\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.`,
  ...
  },
  {
    ...
    description: "Dispositivos ópticos instalados por Falcone para vigilar a los policías que se acercan a la clínica. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven.",
    type: "construction",
    timeLimit: 50,
    maxAttempts: 3,
...
Poste D: CAM-03-C\n\nLa sirena de una ambulancia resonó a varias calles de distancia.\nEl vigilante hacía su ronda alumbrando con una linterna gastada.\nLas gaviotas revoloteaban sobre los barcos pesqueros.\nEl olor a café rancio inundaba la oficina del investigador.\nEl barman limpiaba distraídamente un vaso de cristal.\nEl detective suspiró mientras encendía otro cigarrillo.\nLa sombra de un extraño se proyectó brevemente en la pared.`,
  ...
  },
  {
    ...
    description: "Direcciones IP privadas de la red hospitalaria clandestina que inician en 10 o 192. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros.",
    type: "construction",
    timeLimit: 50,
    maxAttempts: 3,
...
4) 10.200.5.1\n\nEl vigilante hacía su ronda alumbrando con una linterna gastada.\nEl olor a salitre y humo impregnaba el ambiente portuario.\nEl viento soplaba friamente en la calle principal.\nLos faros del vehículo iluminaron por un instante el callejón.\nSe escuchó un crujido proveniente del viejo muelle de madera.\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.`,
  ...
  },
  {
    ...
    description: "Etiquetas sagradas talladas entre llaves literales en los frascos de trasplante primario. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito.",
    type: "construction",
    timeLimit: 50,
    maxAttempts: 3,
...
Frasco {HEPAR} listo.\n\nLa música de jazz sonaba suavemente desde un tocadiscos lejano.\nEl informe de las 04:00 AM no mostraba novedades inusuales.\nSe escuchó un crujido proveniente del viejo muelle de madera.\nEl olor a salitre y humo impregnaba el ambiente portuario.\nEl detective suspiró mientras encendía otro cigarrillo.\nEn la radio se informaba sobre las bajas temperaturas.\nLas cortinas de la habitación 202 estaban completamente cerradas.`,
  ...
  },
  {
    ...
    description: "Tokens alfanuméricos de 6 caracteres con los que los senadores aprueban las transferencias ilícitas. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre.",
    type: "construction",
    timeLimit: 50,
    maxAttempts: 3,
...
Aprobado: AUTH-KL44MN\n\nUn papel arrugado yacía junto al bote de basura.\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nUn perro ladró a lo lejos rompiendo el silencio.\nLos faros del vehículo iluminaron por un instante el callejón.\nSe escuchó un crujido proveniente del viejo muelle de madera.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nEn la radio se informaba sobre las bajas temperaturas.`,
  ...
  // ========================================================
  {
    ...
    description: "Precios de rescate y adquisición de órganos precedidos de la palabra 'COSTE: '. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada.",
    type: "construction",
    timeLimit: 45,
    maxAttempts: 3,
...
ENVIO: $50\n\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nUn perro ladró a lo lejos rompiendo el silencio.\nUna figura envuelta en una gabardina cruzó la avenida.\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nLas gaviotas revoloteaban sobre los barcos pesqueros.\nEl detective suspiró mientras encendía otro cigarrillo.`,
  ...
  },
  {
    ...
    description: "Barriles de conservantes biológicos seguros rotulados como 'LIQUIDO' que NO correspondan a sustancias tóxicas. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal.",
    type: "construction",
    timeLimit: 45,
    maxAttempts: 3,
...
LIQUIDO CELULAR\n\nUn gato negro saltó desde el muro y desapareció en las sombras.\nLas letras del letrero 'ABIERTO' estaban medio fundidas.\nEl ruido sordo de un motor diesel provenía de los almacenes.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nEl vigilante hacía su ronda alumbrando con una linterna gastada.\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nLa sombra de un extraño se proyectó brevemente en la pared.`,
  ...
  },
  {
    ...
    description: "El detonador del escondite de Falcone se activa solo con comandos de detonación armada. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche.",
    type: "criminal_cipher",
    timeLimit: 45,
    maxAttempts: 3,
...
4: DET_99_READY\n\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nEl informe de las 04:00 AM no mostraba novedades inusuales.\nEl eco del agua goteando de una tubería rota marcaba el ritmo de la espera.\nEl olor a salitre y humo impregnaba el ambiente portuario.\nEl vigilante hacía su ronda alumbrando con una linterna gastada.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nUn gato negro saltó desde el muro y desapareció en las sombras.`,
  ...
  },
  {
    ...
    description: "Símbolos mágicos grabados en la puerta de piedra con código hexadecimal de 4 caracteres. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales.",
    type: "construction",
    timeLimit: 45,
    maxAttempts: 3,
...
Runa 4: RUNE_F882 (Brillante)\n\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nEl semáforo parpadeaba en amarillo sin que nadie lo respetara.\nEl vigilante hacía su ronda alumbrando con una linterna gastada.\nSe escuchó un crujido proveniente del viejo muelle de madera.\nLas gaviotas revoloteaban sobre los barcos pesqueros.\nEl viento soplaba friamente en la calle principal.\nEl ruido sordo de un motor diesel provenía de los almacenes.`,
  ...
  },
  {
    ...
    description: "Identificadores en clave de los senadores y magistrados que recibieron trasplantes ilegales. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes.",
    type: "construction",
    timeLimit: 45,
    maxAttempts: 3,
...
Paciente: SENATOR-CHI\n\nLos ecos de pasos apresurados resonaban en el callejón vacío.\nEl olor a salitre y humo impregnaba el ambiente portuario.\nLas letras del letrero 'ABIERTO' estaban medio fundidas.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nUn perro ladró a lo lejos rompiendo el silencio.\nEn la radio se informaba sobre las bajas temperaturas.\nNadie parecía notar el rastro dejado en el asfalto mojado.`,
  ...
  },
  {
    ...
    description: "Lecturas térmicas bajo cero de los congeladores de órganos que inician con signo negativo y símbolo de grado. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven.",
    type: "construction",
    timeLimit: 45,
    maxAttempts: 3,
    documentTitle: "TERMÓMETROS DE CONGELACIÓN",
    sourceText: `Las cortinas de la habitación 202 estaban completamente cerradas.\nEl viento soplaba friamente en la calle principal.\nEl olor a café rancio inundaba la oficina del investigador.\nEl conserje dormitaba en su silla sin prestar atención.\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.\nUna figura envuelta en una gabardina cruzó la avenida.\n\nREGISTRO TÉRMICO:
Congelador A: -18°C
Congelador B: -24°C
Ambiente: +20°C
Congelador C: -40°C\n\nUn coche negro aceleró y dobló la esquina rápidamente.\nEn la radio se informaba sobre las bajas temperaturas.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nUn periódico viejo volaba arrastrado por la brisa otoñal.\nUn archivo polvoriento reposaba sobre el escritorio.\nNadie se atrevía a caminar por ese sector después del anochecer.\nEl ruido sordo de un motor diesel provenía de los almacenes.\nEl barman limpiaba distraídamente un vaso de cristal.`,
  ...
  },
  {
    ...
    description: "Líneas de energía de alta tensión que mantienen activos los congeladores portuarios. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros.",
    type: "construction",
    timeLimit: 45,
    maxAttempts: 3,
...
Circuito 4: LINEA_440_OK\n\nNadie se atrevía a caminar por ese sector después del anochecer.\nLos faros del vehículo iluminaron por un instante el callejón.\nLas huellas en el barro indicaban que alguien había estado allí recientemente.\nEl viento soplaba friamente en la calle principal.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nEl detective suspiró mientras encendía otro cigarrillo.\nLas gaviotas revoloteaban sobre los barcos pesqueros.\nUn gato negro saltó desde el muro y desapareció en las sombras.`,
  ...
  },
  {
    ...
    description: "Órdenes judiciales emitidas para arrestar a los fiscales cómplices de la clínica. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito.",
    type: "construction",
    timeLimit: 45,
    maxAttempts: 3,
...
Caso D: WARRANT-88310 (Comisionado Adjunto)\n\nEl detective suspiró mientras encendía otro cigarrillo.\nLa sirena de una ambulancia resonó a varias calles de distancia.\nLa sombra de un extraño se proyectó brevemente en la pared.\nEl olor a café rancio inundaba la oficina del investigador.\nUn gato negro saltó desde el muro y desapareció en las sombras.\nUn coche negro aceleró y dobló la esquina rápidamente.\nLas gaviotas revoloteaban sobre los barcos pesqueros.\nEl ruido sordo de un motor diesel provenía de los almacenes.`,
  ...
  },
  {
    ...
    description: "Velas consagradas con sebo humano para alimentar la presencia del demonio. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre.",
    type: "construction",
    timeLimit: 45,
    maxAttempts: 3,
...
Altar oeste: CANDLE_BLACK_9\n\nEl semáforo parpadeaba en amarillo sin que nadie lo respetara.\nEl conserje dormitaba en su silla sin prestar atención.\nUn archivo polvoriento reposaba sobre el escritorio.\nEl candado de la puerta trasera parecía oxidado pero intacto.\nNadie se atrevía a caminar por ese sector después del anochecer.\nSe escuchó un crujido proveniente del viejo muelle de madera.\nLas cajas apiladas formaban un laberinto casi impenetrable.\nEl barman limpiaba distraídamente un vaso de cristal.`,
  ...
  },
  {
    ...
    description: "Cerradura de triple combinación que custodia el arcón primigenio del contrato. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada.",
    type: "construction",
    timeLimit: 45,
    maxAttempts: 3,
...
Cerradura 4: VAULT-EF-8812 (Aprobada)\n\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nLos ecos de pasos apresurados resonaban en el callejón vacío.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nUn papel arrugado yacía junto al bote de basura.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nEl conserje dormitaba en su silla sin prestar atención.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nNadie se atrevía a caminar por ese sector después del anochecer.`,
  ...
  // ========================================================
  {
    ...
    subtitle: "Terminal Central de Redes",
    description: "El demonio introdujo un patrón malicioso ^(x+)+y$ que congela los servidores policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal.",
    type: "criminal_cipher",
    timeLimit: 35,
    maxAttempts: 3,
...
xxxxxxxxxxxxxxxxxxxxxxxxxxxx (sin 'y' al final)\n\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nUn coche negro aceleró y dobló la esquina rápidamente.\nUn relámpago iluminó el cielo amenazando con una tormenta inminente.\nNadie se atrevía a caminar por ese sector después del anochecer.\nEl conserje dormitaba en su silla sin prestar atención.\nEl ruido sordo de un motor diesel provenía de los almacenes.\nLas cajas apiladas formaban un laberinto casi impenetrable.\nLas letras del letrero 'ABIERTO' estaban medio fundidas.`,
  ...
  },
  {
    ...
    description: "Vance implementa un token lineal sin anidamiento para reactivar los sistemas de emergencia. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche.",
    type: "construction",
    timeLimit: 35,
    maxAttempts: 3,
...
Token D: SEC_TOKEN_8812\n\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nLas cortinas de la habitación 202 estaban completamente cerradas.\nEl informe de las 04:00 AM no mostraba novedades inusuales.\nLos ecos de pasos apresurados resonaban en el callejón vacío.\nNadie se atrevía a caminar por ese sector después del anochecer.\nUn gato negro saltó desde el muro y desapareció en las sombras.\nLas cajas apiladas formaban un laberinto casi impenetrable.\nEl olor a café rancio inundaba la oficina del investigador.`,
  ...
  },
  {
    ...
    description: "Falcone instaló detonadores de mercurio hipersensibles en las paredes del hospital. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales.",
    type: "construction",
    timeLimit: 35,
    maxAttempts: 3,
...
Bomba 4: MERCURY-882-C\n\nUn coche negro aceleró y dobló la esquina rápidamente.\nEn la radio se informaba sobre las bajas temperaturas.\nUn relámpago iluminó el cielo amenazando con una tormenta inminente.\nUn archivo polvoriento reposaba sobre el escritorio.\nUn papel arrugado yacía junto al bote de basura.\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.\nEl detective suspiró mientras encendía otro cigarrillo.\nEl conserje dormitaba en su silla sin prestar atención.`,
  ...
  },
  {
    ...
    description: "La doctora configuró un comando ritual para invocar el alma o la carne de los deudores. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil.",
    type: "criminal_cipher",
    timeLimit: 35,
    maxAttempts: 3,
...
4: INVOKE_AB_SOUL\n\nLos faros del vehículo iluminaron por un instante el callejón.\nSe escuchó un crujido proveniente del viejo muelle de madera.\nEl semáforo parpadeaba en amarillo sin que nadie lo respetara.\nUn papel arrugado yacía junto al bote de basura.\nLa sirena de una ambulancia resonó a varias calles de distancia.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nEl detective suspiró mientras encendía otro cigarrillo.`,
  ...
  },
  {
    ...
    description: "Falcone aparcó vehículos cargados con explosivos para impedir que la policía rescate a los heridos. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven.",
    type: "construction",
    timeLimit: 35,
    maxAttempts: 3,
...
Auto 4: CAR_BOMB_03 (Cebado)\n\nLa sirena de una ambulancia resonó a varias calles de distancia.\nEl viento soplaba friamente en la calle principal.\nUn archivo polvoriento reposaba sobre el escritorio.\nEl olor a salitre y humo impregnaba el ambiente portuario.\nLas cajas apiladas formaban un laberinto casi impenetrable.\nSe escuchó un crujido proveniente del viejo muelle de madera.\nLa música de jazz sonaba suavemente desde un tocadiscos lejano.\nUn periódico viejo volaba arrastrado por la brisa otoñal.\nUn perro ladró a lo lejos rompiendo el silencio.`,
  ...
  },
  {
    ...
    description: "La embarcación blindada de Falcone lista para zarpar con los últimos millones de dólares saqueados. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros.",
    type: "construction",
    timeLimit: 35,
    maxAttempts: 3,
...
Lancha de escolta: FALCONE_ESCAPE_303\n\nLa sombra de un extraño se proyectó brevemente en la pared.\nUn archivo polvoriento reposaba sobre el escritorio.\nSe escuchó un crujido proveniente del viejo muelle de madera.\nUn gato negro saltó desde el muro y desapareció en las sombras.\nEl olor a salitre y humo impregnaba el ambiente portuario.\nUn papel arrugado yacía junto al bote de basura.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nEl conserje dormitaba en su silla sin prestar atención.\nEn la radio se informaba sobre las bajas temperaturas.`,
  ...
  },
  {
    ...
    description: "Huellas dactilares aberrantes dejadas sobre el acero que no pertenecen a ninguna especie conocida. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito.",
    type: "construction",
    timeLimit: 35,
    maxAttempts: 3,
...
Muestra D: PRINT_NON_HUMAN_03\n\nUn perro ladró a lo lejos rompiendo el silencio.\nUn coche negro aceleró y dobló la esquina rápidamente.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nSe escuchó un crujido proveniente del viejo muelle de madera.\nEl olor a café rancio inundaba la oficina del investigador.\nEl vigilante hacía su ronda alumbrando con una linterna gastada.\nUn periódico viejo volaba arrastrado por la brisa otoñal.\nLa sombra de un extraño se proyectó brevemente en la pared.\nEl conserje dormitaba en su silla sin prestar atención.`,
  ...
  },
  {
    ...
    description: "La caldera principal fue saboteada para hacer estallar el santuario si Vance desactiva el altar. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre.",
    type: "construction",
    timeLimit: 35,
    maxAttempts: 3,
...
Válvula 4: VALVE_04_CRITICAL (Sobrepresión)\n\nEl conserje dormitaba en su silla sin prestar atención.\nUn coche negro aceleró y dobló la esquina rápidamente.\nLas letras del letrero 'ABIERTO' estaban medio fundidas.\nLa música de jazz sonaba suavemente desde un tocadiscos lejano.\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nEl informe de las 04:00 AM no mostraba novedades inusuales.\nEl detective suspiró mientras encendía otro cigarrillo.\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.`,
  ...
  },
  {
    ...
    description: "El diario íntimo de la doctora donde confiesa cómo firmó el pacto con Malphas al envejecer. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada.",
    type: "construction",
    timeLimit: 35,
    maxAttempts: 3,
...
Portal 4: OPEN_GATE_FIRE\n\nEl conserje dormitaba en su silla sin prestar atención.\nUn perro ladró a lo lejos rompiendo el silencio.\nNadie se atrevía a caminar por ese sector después del anochecer.\nEl olor a café rancio inundaba la oficina del investigador.\nLa sirena de una ambulancia resonó a varias calles de distancia.\nLos ecos de pasos apresurados resonaban en el callejón vacío.\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nSe escuchó un crujido proveniente del viejo muelle de madera.`,
  ...
  // ========================================================
  {
    ...
    description: "Lecturas electromagnéticas que capturan la presencia física del demonio en la cripta. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche.",
    type: "construction",
    timeLimit: 30,
    maxAttempts: 2,
...
Señal Gamma: MALPHAS_AURA_882\n\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nLas cortinas de la habitación 202 estaban completamente cerradas.\nEl conserje dormitaba en su silla sin prestar atención.\nUn perro ladró a lo lejos rompiendo el silencio.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nLos faros del vehículo iluminaron por un instante el callejón.\nLos ecos de pasos apresurados resonaban en el callejón vacío.`,
  ...
  },
  {
    ...
    description: "¡Solo 30 segundos! El camión blindado con las últimas pruebas intenta abordar el buque. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales.",
    type: "construction",
    timeLimit: 30,
    maxAttempts: 2,
...
Camión 3: FINAL_TRUCK_882\n\nNadie se atrevía a caminar por ese sector después del anochecer.\nLos faros del vehículo iluminaron por un instante el callejón.\nEl candado de la puerta trasera parecía oxidado pero intacto.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nLa sirena de una ambulancia resonó a varias calles de distancia.\nUna figura envuelta en una gabardina cruzó la avenida.\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.\nLos ecos de pasos apresurados resonaban en el callejón vacío.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.`,
  ...
  },
  {
    ...
    description: "Falcone programó la carga final de C4 para colapsar las catacumbas enteras sobre el detective. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil.",
    type: "criminal_cipher",
    timeLimit: 30,
    maxAttempts: 2,
...
4: OMEGA_12_EXTERMINATE\n\nEl viento soplaba friamente en la calle principal.\nLas gaviotas revoloteaban sobre los barcos pesqueros.\nLa música de jazz sonaba suavemente desde un tocadiscos lejano.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nUn coche negro aceleró y dobló la esquina rápidamente.\nSe escuchó un crujido proveniente del viejo muelle de madera.\nEl vigilante hacía su ronda alumbrando con una linterna gastada.\nEl candado de la puerta trasera parecía oxidado pero intacto.\nEn la radio se informaba sobre las bajas temperaturas.`,
  ...
  },
  {
    ...
    description: "Invocaciones reflejadas en el espejo que comienzan con '@DEMON_' y concluyen con el signo de dólar. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes.",
    type: "construction",
    timeLimit: 30,
    maxAttempts: 2,
...
@DEMON_FAIL\n\nLa música de jazz sonaba suavemente desde un tocadiscos lejano.\nEl candado de la puerta trasera parecía oxidado pero intacto.\nUn coche negro aceleró y dobló la esquina rápidamente.\nLas alcantarillas emitían un leve vapor debido al frío de la madrugada.\nLos ecos de pasos apresurados resonaban en el callejón vacío.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nEl viento soplaba friamente en la calle principal.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nEl semáforo parpadeaba en amarillo sin que nadie lo respetara.`,
  ...
  },
  {
    ...
    subtitle: "Terminal Central de la Clínica",
    description: "Vance detiene el borrado electromagnético de los expedientes de trasplante antes de que se pierdan. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros.",
    type: "construction",
    timeLimit: 30,
    maxAttempts: 2,
...
Comando 4: ABORT_PURGE_8812\n\nNadie parecía notar el rastro dejado en el asfalto mojado.\nUna figura envuelta en una gabardina cruzó la avenida.\nUn coche negro aceleró y dobló la esquina rápidamente.\nLa música de jazz sonaba suavemente desde un tocadiscos lejano.\nEl barman limpiaba distraídamente un vaso de cristal.\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.\nEl olor a salitre y humo impregnaba el ambiente portuario.\nEl eco del agua goteando de una tubería rota marcaba el ritmo de la espera.\nEl olor a café rancio inundaba la oficina del investigador.\nEl ruido sordo de un motor diesel provenía de los almacenes.`,
  ...
  },
  {
    ...
    description: "El libro indica la primera regla del conjuro: 'Una palabra de 6 mayúsculas que selle un pacto al inicio del renglón'. Coteja tus evidencias pasadas. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito.",
    type: "construction",
    timeLimit: 30,
    maxAttempts: 2,
...
VERITAS prevalecerá al final.\n\nEl detective suspiró mientras encendía otro cigarrillo.\nEl eco del agua goteando de una tubería rota marcaba el ritmo de la espera.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nLos faros del vehículo iluminaron por un instante el callejón.\nEl informe de las 04:00 AM no mostraba novedades inusuales.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nLas letras del letrero 'ABIERTO' estaban medio fundidas.\nUn gato negro saltó desde el muro y desapareció en las sombras.`,
  ...
  },
  {
    ...
    subtitle: "Bóveda de Malphas • El Tratado de los Ecos",
    description: "La segunda regla del conjuro: 'El símbolo de clausura que rompe el contrato al final de la línea'. Coteja los telegramas del Caso 23. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre.",
    type: "construction",
    timeLimit: 30,
    maxAttempts: 2,
...
Transmisión sin terminar\n\nNadie se atrevía a caminar por ese sector después del anochecer.\nEl viento soplaba friamente en la calle principal.\nEl vigilante hacía su ronda alumbrando con una linterna gastada.\nUn relámpago iluminó el cielo amenazando con una tormenta inminente.\nUn papel arrugado yacía junto al bote de basura.\nLas huellas en el barro indicaban que alguien había estado allí recientemente.\nNadie parecía notar el rastro dejado en el asfalto mojado.\nEl reloj del ayuntamiento marcó la medianoche con un sonido lúgubre.\nLas letras del letrero 'ABIERTO' estaban medio fundidas.\nUn archivo polvoriento reposaba sobre el escritorio.`,
  ...
  },
  {
    ...
    subtitle: "Bóveda de Malphas • El Tratado de los Ecos",
    description: "La tercera regla: 'El tributo robado en los frascos: selecciona únicamente entre CARNE o COR sin gastar memoria de captura'. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada.",
    type: "construction",
    timeLimit: 30,
    maxAttempts: 2,
...
Frasco 3: OJO de cristal\n\nLos ecos de pasos apresurados resonaban en el callejón vacío.\nEl tren de las 3:15 pasó haciendo vibrar las paredes del edificio.\nHabía colillas de cigarrillos esparcidas cerca de la entrada.\nNadie se atrevía a caminar por ese sector después del anochecer.\nEl ruido sordo de un motor diesel provenía de los almacenes.\nUn periódico viejo volaba arrastrado por la brisa otoñal.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nEl informe de las 04:00 AM no mostraba novedades inusuales.\nUn gato negro saltó desde el muro y desapareció en las sombras.\nUn archivo polvoriento reposaba sobre el escritorio.`,
  ...
  },
  {
    ...
    subtitle: "Bóveda de Malphas • El Tratado de los Ecos",
    description: "La cuarta regla del libro: 'La palabra de la verdad que no esté precedida por el engaño del demonio'. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal.",
    type: "construction",
    timeLimit: 30,
    maxAttempts: 2,
...
SOLA VERITAS (Juicio final)\n\nEl semáforo parpadeaba en amarillo sin que nadie lo respetara.\nUn perro ladró a lo lejos rompiendo el silencio.\nEl detective suspiró mientras encendía otro cigarrillo.\nGotas de lluvia golpeaban incesantemente el cristal de la ventana.\nLas luces de neón parpadeaban sin cesar en la noche oscura.\nUn gato negro saltó desde el muro y desapareció en las sombras.\nLa música de jazz sonaba suavemente desde un tocadiscos lejano.\nLas gaviotas revoloteaban sobre los barcos pesqueros.\nEl viento soplaba friamente en la calle principal.\nUna figura envuelta en una gabardina cruzó la avenida.`,
  ...
  },
  {
    ...
    description: "¡El clímax supremo! Abre el arcón donde arde el contrato primigenio de Malphas introduciendo la combinación maestra sagrada que calcina el pacto y destierra al demonio para siempre. Investigaciones posteriores revelaron que el sindicato de Falcone había establecido puntos ciegos en esta zona específica para eludir las patrullas policiales. Además, el detective Vance notó un patrón recurrente en los registros telefónicos interceptados cerca de la escena, vinculando a figuras públicas de alto perfil. La Dra. Cross parece estar involucrada directamente; los archivos recuperados del sanatorio coinciden con el modus operandi documentado en estos reportes. Las piezas del rompecabezas comienzan a formar una imagen aterradora sobre la red de trasplantes clandestinos y la impunidad en las altas esferas de New Haven. Restos biológicos anómalos fueron detectados por los peritos forenses, sugiriendo técnicas quirúrgicas demasiado avanzadas para simples criminales callejeros. Un confidente anónimo filtró que las sumas de dinero manejadas en estas transacciones superan con creces el presupuesto de toda la comisaría del distrito. Las sombras del Hotel Noir y los callejones industriales esconden más que contrabando; ocultan el precio de la inmortalidad comprada con sangre. Documentos chamuscados hallados en una bóveda secreta hacen alusión al infame 'Tratado de los Ecos', confirmando que el aspecto ritual no era solo una fachada. La tensión en la comisaría aumenta; asuntos internos ha comenzado a confiscar evidencias clave, obligando a Vance a guardar una copia de estos archivos en su maletín personal. Cada nueva pista consolida la teoría de que el colapso de las líneas telefónicas no fue un accidente, sino una maniobra orquestada para silenciar testigos clave esa noche.",
    type: "construction",
    timeLimit: 30,
    maxAttempts: 2,
